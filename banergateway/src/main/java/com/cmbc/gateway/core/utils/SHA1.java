...
public class SHA1 {
	...
	public static void main(String[] args) {
		String data = "jsapi_ticket=bxLdikRXVbTPdHSM05e5u253l5CCdJkZpF3cG0ioak4dWvwYluBJMqXOLwbjvwRYwzbm8WBQgx-fQH4iHiQTQg&noncestr=Wm3WZYTPz0wzccnW&timestamp=1453877079&url=http://paotuan.duapp.com/wechat/www/merchant.html";
		log.info(data);
		String digest = new SHA1().getDigestOfString(data.getBytes());
		log.info(digest);

		// log.info( ToMD5.convertSHA1(data).toUpperCase());
	}
